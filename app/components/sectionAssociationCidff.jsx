      ...
      <div className="mx-auto px-4 md:px-8 py-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <p className="text-white leading-relaxed text-base font-normal mb-6">
            ...
            (CIDFF) de Bourges est une association loi 1901 exerçant une mission
            d'intérêt général confiée par l'État. Son objectif est double :
            favoriser l'autonomie sociale, professionnelle et personnelle des
            femmes, et promouvoir l'égalité entre les femmes et les hommes.
            Basée à Bourges, l'association propose gratuitement et en toute
            confidentialité des consultations juridiques, un accompagnement vers
            l'emploi et un soutien aux victimes de violences. Elle s'inscrit
            dans un réseau national de près d'une centaine de CIDFF présents sur
